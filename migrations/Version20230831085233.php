 ...
 */
final class Version20230831085233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, company_name VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, activity VARCHAR(255) DEFAULT NULL, address VARCHAR(255) NOT NULL, address_line2 VARCHAR(255) DEFAULT NULL, city VARCHAR(255) NOT NULL, postal_code VARCHAR(255) NOT NULL, website VARCHAR(255) DEFAULT NULL, country VARCHAR(255) NOT NULL, company_address VARCHAR(255) DEFAULT NULL, billing_address VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(255) NOT NULL, notes LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_81398E09979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE invoice (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, customer_id INT NOT NULL, quotation_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, bill_number VARCHAR(255) NOT NULL, from_date DATE DEFAULT NULL, delivery_date DATE NOT NULL, total_price DOUBLE PRECISION NOT NULL, vat DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, payment_method VARCHAR(255) NOT NULL, payment_days VARCHAR(255) NOT NULL, payment_date_limit DATE NOT NULL, created_at DATETIME NOT NULL, bill_validity_duration VARCHAR(255) NOT NULL, INDEX IDX_90651744979B1AD6 (company_id), INDEX IDX_906517449395C3F3 (customer_id), UNIQUE INDEX UNIQ_90651744B4EA4E60 (quotation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
